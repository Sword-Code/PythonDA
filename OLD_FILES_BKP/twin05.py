...
def plot_results(arrays=None, truth_t_array=None, delta_obs_array=None, forget_array=None, EnsSize_array=None, titles=['Total RMSE','Observed RMSE','Unobserved RMSE'], cmaps=['seismic_r','YlGn_r'], max_metric=6.0, save=False, folder='SAVED'):
